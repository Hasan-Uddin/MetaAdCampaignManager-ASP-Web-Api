...
{
    Uri GetLoginUrl(string appId, string redirectUri, string state);
    ...
    Task<Result<List<MetaAppInfo>>> GetUserAppsAsync(string accessToken, CancellationToken ct = default);
}
...
public sealed record MetaAppInfo(string Id, string Name, string Category);
